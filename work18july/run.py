...
def read_lammps_data_positions(number):
    middle = str(number)
    filename = "./configurations_ljsmoothcont_10k/confdump.500000k."+middle+".data"
...
while(True):
    ...
    middle = str(increment)
    filename = "./modfied/confdump.500000k.modified"+middle+".data"
    os.system('touch ${filename}')
    filemod = open("./modfied/confdump.500000k.modified"+middle+".data", "a")
