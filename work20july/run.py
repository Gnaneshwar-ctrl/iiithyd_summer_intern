...
def read_lammps_data_positions(number):
    middle = str(number)
    filename = "./run_initial/confdump.10000000."+middle+".data"
...
while(True):
    ...
    filename = "./modfied_new/confdump.modified.10000000"+middle+".data"
    os.system('touch ${filename}')
    filemod = open("./modfied_new/confdump.modified.10000000"+middle+".data", "a")
